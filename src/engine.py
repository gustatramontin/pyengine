...
class Model:
    ...
    def setvertex(self, fn):
        self.vertex_shader = lambda s: fn(s)
...
class Window:
    ...
    def add_loop(self, fn):
        self.procs.append(lambda s: fn(s))
    def render_model(self, model):
        w,h,screen = self.w, self.h, self.screen
